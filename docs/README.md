...
The deployment url is: [https://arquisoft.github.io/lomap_es1b33/](https://arquisoft.github.io/lomap_es1b33/).
...
If we want to deploy it to GitHub pages, so it is accesible via [https://arquisoft.github.io/lomap_es1b33/](https://arquisoft.github.io/lomap_es1b33/) we need to execute `npm run deploy`.
